...
var (
	SERVER1, SERVER2, SERVER3, SERVER4, SERVER5, SERVER6, SERVER7, SERVER8, SERVER9, SERVER10, SHAREDRIVEPATH string
)

func LoadEnv() {
	err := godotenv.Load("S:\\Cust_Serv\\Help Desk Info\\Help Desk PC Setup Docs\\Home Grown Tools\\URMC-HUB\\.env")
	if err != nil {
	...
	SHAREDRIVEPATH = os.Getenv("SHAREDRIVEPATH")
